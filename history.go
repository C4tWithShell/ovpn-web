...
type History struct {
	...
	Rip           string    `gorm:"column:rip;comment:'User IP'" json:"rip" form:"rip"`
	CommonName    string    `gorm:"column:common_name;comment:'Client name'" json:"common_name" form:"common_name"`
	Username      string    `gorm:"column:username;comment:'Username'" json:"username" form:"username"`
	BytesReceived float64   `gorm:"comment:'Download data'" form:"bytes_received" json:"bytes_received"`
	BytesSent     float64   `gorm:"comment:'Upload data'" json:"bytes_sent" form:"bytes_sent"`
	TimeUnix      int64     `gorm:"comment:'Uptime'" json:"time_unix" form:"time_unix"`
	TimeDuration  int64     `gorm:"column:time_duration;comment:'Time online'" json:"time_duration" form:"time_duration"`
